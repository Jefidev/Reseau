...
BEGIN
	...
	INSERT INTO PARC (X, Y, ID_CONTAINER, ETAT, DATE_RESERVATION, DATE_ARRIVEE, POIDS, DESTINATION, TRANSPORT) VALUES (4, 4, NULL, 1, '11/10/2015', '15/09/2015', 100, 'Seraing', 'BATEAU');
	INSERT INTO PARC (X, Y, ID_CONTAINER, ETAT, DATE_RESERVATION, DATE_ARRIVEE, POIDS, DESTINATION, TRANSPORT) VALUES (5, 6, NULL, 2, '5/10/2015', '9/10/2015', 200, 'Verviers', 'TRAIN');
