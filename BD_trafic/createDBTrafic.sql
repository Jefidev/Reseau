...
(
	ID_RESERVATION		VARCHAR2(20),
	ID_CONTAINER		VARCHAR2(20),
	X 					NUMBER(3),
	Y 					NUMBER(3),
	DATE_RESERVATION	VARCHAR(10),
	DATE_ARRIVEE		VARCHAR(10),
	DESTINATIONS 		VARCHAR(20) CONSTRAINT REF_RESERVATIONS_DESTINATIONS REFERENCES DESTINATIONS(VILLE),
	CONSTRAINT REF_RESERVATIONS_PARC FOREIGN KEY (X, Y) REFERENCES PARC(X, Y),
	CONSTRAINT PK_RESERVATION PRIMARY KEY (ID_RESERVATION, ID_CONTAINER)
);
