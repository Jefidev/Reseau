...
(
	ID_PERSONNEL	VARCHAR2(20) CONSTRAINT PK_PERSONNEL PRIMARY KEY,
	NOM				VARCHAR2(50),
	PRENOM			VARCHAR2(50),
	LOGIN			VARCHAR2(30),
...
(
	...
	ID_COMPTABLE		VARCHAR2(20) CONSTRAINT REF_FACTURES_PERSONNEL REFERENCES PERSONNEL(ID_PERSONNEL),
	FLAG_FACT_ENVOYEE	NUMBER(1),
	MOYEN_ENVOI			NUMBER(1),
...
(
	...
	NOM					VARCHAR2(50) CONSTRAINT REF_SALAIRES_NOM REFERENCES PERSONNEL(NOM),
	PRENOM				VARCHAR2(50) CONSTRAINT REF_SALAIRES_PRENOM REFERENCES PERSONNEL(PRENOM),
	MOIS_ANNEE			VARCHAR2(7),
	MONTANT_BRUT		NUMBER,
	RETRAIT_ONNS		NUMBER,
...
(
	...
	TARIF				NUMBER,
	TYPE_OCCUP_MANIP	NUMBER(1),
	MATERIEL			VARCHAR2(20),
	FLAG_PETROLIER		NUMBER(1),
	DATELASTUPDATE		VARCHAR2(10)
);
